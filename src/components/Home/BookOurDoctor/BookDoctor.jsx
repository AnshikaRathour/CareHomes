				...
				<div className="row">
					<div className="col-12 col-md-3 col-lg-3">
						...
						<div className="form-text">
							<p>Experience seamless doctor appointment booking with Care Homes. Our intuitive platform allows you to effortlessly schedule appointments online, ensuring you receive timely care without the hassle of traditional booking methods.</p>
